...
namespace AssistData
{
    class Register
    {
        ...
        public bool SetByte(uint index, int value)
        {
            ...
            try
            {
                //registerContents[index] = Byte.Parse(value.ToString());
        ...
        public bool SetByte(uint index, string value)
        {
            ...
            try
            {
                ...
                //registerContents[index] = Byte.Parse(tempVal.ToString());
        ...
        public bool SetBytes(uint index, int[] values)
        {
            ...
            try
            {
                ...
                {
                    //registerContents[index + offset] = Byte.Parse(val.ToString());
        ...
        public bool SetBytes(uint index, string[] values)
        {
            ...
            try
            {
                foreach (string val in values)
                {
                    ...
                    //registerContents[index + offset] = Byte.Parse(tempVal.ToString());
        ...
        private void InitializeRegisterContents()
        {
            ...
            for (uint i = 0; i < REGISTER_SIZE; i++)
            {
                ...
                //registerContents[i] = Byte.Parse(tempVal);
